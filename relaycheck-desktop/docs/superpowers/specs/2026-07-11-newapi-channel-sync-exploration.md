...
**日期：** 2026-07-11  
**状态：** 8.1 + 8.5 + 8.3 + 8.4 排除审计 + 8.2 持久摘要已实现  
...
| 2026-07-11 | 8.4：同步结果 skippedExcludedSamples/Truncated + GET /api/local-newapi/exclude-rules；8.2：last_sync_at/summary ensureColumn + List/Get/Sync 回写；LocalNewAPISyncPanel 展示上次摘要与排除样例 |
