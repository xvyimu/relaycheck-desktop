...
export function LineIcon({ name, className = "" }: { name: LineIconName; className?: string }) {
  ...
  return (
    <svg className={`line-icon ${className}`.trim()} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      {name === "dashboard" ? (
        <>
          <rect x="4" y="4" width="6" height="7" rx="1.5" {...common} />
          <rect x="14" y="4" width="6" height="4" rx="1.5" {...common} />
          <rect x="4" y="15" width="6" height="5" rx="1.5" {...common} />
          <rect x="14" y="12" width="6" height="8" rx="1.5" {...common} />
        </>
      ) : null}
      {name === "channels" ? (
        <>
      ...
      {name === "sites" ? (
        <>
          ...
          <path d="M4 12h16M12 4a12 12 0 0 1 0 16M12 4a12 12 0 0 0 0 16" {...common} />
        </>
      ) : null}
      {name === "accounts" ? (
        <>
          ...
          <path d="M16 11h4M18 9v4" {...common} />
        </>
      ) : null}
      {name === "checkins" ? (
        <>
          <path d="M5 13l4 4L19 7" {...common} />
          <path d="M4 5h8" {...common} />
      ...
      {name === "balances" ? (
        <>
          <circle cx="12" cy="12" r="8" {...common} />
          <path
            d="M12 7v10M9 9.5c0-1.2 1.1-2 3-2 1.2 0 2 .35 2.5.8M15 14.5c0 1.2-1.1 2-3 2-1.2 0-2-.35-2.5-.8"
            {...common}
          />
        </>
      ) : null}
      {name === "notifications" ? (
        <>
          <path d="M6 10a6 6 0 1 1 12 0c0 4 2 5 2 5H4s2-1 2-5" {...common} />
      ...
      {name === "settings" ? (
        <>
          ...
          <path
            d="M12 3v3M12 18v3M4.8 4.8l2.1 2.1M17.1 17.1l2.1 2.1M3 12h3M18 12h3M4.8 19.2l2.1-2.1M17.1 6.9l2.1-2.1"
            {...common}
          />
        </>
      ) : null}
      ...
      {name === "warning" ? (
        <>
          <path d="M12 4l9 16H3L12 4z" {...common} />
