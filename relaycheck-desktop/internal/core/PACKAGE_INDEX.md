...
| `accounts.go` | Forwarders to `*accounts.Service`: account CRUD HTTP handlers plus thin compatibility wrappers for browser login, account validation, cleanup, and account-site update services. |
